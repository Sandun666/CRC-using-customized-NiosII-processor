...
JDI_FILE := E:/Semester_06/CO503_Advanced_Embedded_Systems/Practicals/Practical_2_Processor_Customizations/Lab2/TopLevel.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := E:/Semester_06/CO503_Advanced_Embedded_Systems/Practicals/Practical_2_Processor_Customizations/Lab2/SoC.sopcinfo
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1646309026
SOPC_SYSID_FLAG += --timestamp=1646309026
ELF_PATCH_FLAG  += --timestamp 1646309026
...
# setting hal.stderr is jtag_urt
ELF_PATCH_FLAG  += --stderr_dev jtag_urt

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_urt
ELF_PATCH_FLAG  += --stdin_dev jtag_urt
...
# setting hal.stdout is jtag_urt
ELF_PATCH_FLAG  += --stdout_dev jtag_urt
