...
MEM_0 := sdramController
$(MEM_0)_NAME := sdramController
...
$(MEM_0)_HIERARCHICAL_PATH := sdramController
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: sdramController
sdramController: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
